...
export default function About() {
  return <>
    ...
    <section className="section"><div className="container split"><div className="about-video"><video autoPlay muted loop playsInline preload="metadata" poster="/images/projects/residential-home-elevator/lobby-entrance-wide.jpg" aria-label="Gentle Elevators completed residential elevator showcase"><source src="/videos/residential-home-elevator-showcase.mp4" type="video/mp4" />Your browser does not support embedded video.</video></div><div><Eyebrow>Who we are</Eyebrow><h2>TECHNICAL CARE. PROFESSIONAL SERVICE.</h2><p>Gentle Elevators has provided elevator installation, repair, maintenance, modernization, and safety inspection services since {companyInfo.established}. Based in {companyInfo.location}, we support residential and commercial buildings throughout {companyInfo.serviceArea}.</p><div className="company-facts"><div><strong>{companyInfo.established}</strong><span>Established</span></div><div><strong>Lebanon</strong><span>Nationwide service</span></div><div><strong>AR / EN</strong><span>Arabic &amp; English</span></div></div><div className="mission-grid"><div><h3>Our mission</h3><p>To provide safe, dependable, and high-quality elevator solutions for every customer.</p></div><div><h3>Our vision</h3><p>To become a trusted elevator company known for professional service, strong technical work, and long-term customer relationships.</p></div></div></div></div></section>
