...
export default function Home() {
  return <>
    ...
    <section className="section why"><div className="container"><Eyebrow>Why Gentle</Eyebrow><h2>WHY CHOOSE GENTLE ELEVATORS?</h2><div className="why-grid">{why.map(item => <div key={item}><Check /><span>{item}</span></div>)}</div></div></section>
