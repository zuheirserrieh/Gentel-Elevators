...
export const services = [
  ...
  {
    slug: "repair", title: "Elevator Repair", titleAr: "إصلاح المصاعد", icon: Wrench, image: "/images/services/repair.png", imagePosition: "82% 49%",
  ...
  {
    slug: "maintenance", title: "Elevator Maintenance", titleAr: "صيانة المصاعد", icon: Settings, image: "/images/services/maint.png", imagePosition: "76% 48%",
  ...
  {
    slug: "modernization", title: "Elevator Modernization", titleAr: "تحديث المصاعد", icon: RefreshCw, image: "/images/services/mode.png", imagePosition: "38% 48%",
